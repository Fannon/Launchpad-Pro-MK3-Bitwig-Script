...
import io.github.fannon.novation.internal.HostErrorOutputStream;
import io.github.fannon.novation.internal.HostOutputStream;
import io.github.fannon.novation.internal.Session;
import io.github.fannon.novation.modes.AbstractMode;
import io.github.fannon.novation.modes.DrumPadMode;
import io.github.fannon.novation.modes.SessionMode;
import io.github.fannon.novation.modes.mixer.*;
...
public class LaunchpadProMk3Extension extends ControllerExtension
{
   private Session mSession;
   private HardwareSurface mSurface;
   private LaunchpadProMk3Surface mLSurface;
   private ModeMachine mMachine;

   protected LaunchpadProMk3Extension(final LaunchpadProMk3ExtensionDefinition definition, final ControllerHost host)
   {
   ...
   public void init()
   {
      ...
      System.out.println("Launchpad Pro Mk3 init()");
...
//      BooleanValue mFollowCursorTrack = prefs.getBooleanSetting("Follow Cursor Track?", "Behavior", true);
      ...
      mLSurface = new LaunchpadProMk3Surface(host, mSession, mSurface);
...
//      MidiIn dawIn = mSession.midiIn(ChannelType.DAW);
      ...
      System.out.println("Launchpad Pro Mk3 Initialized");
   ...
   {
      mSession.shutdown();
      System.out.println("Launchpad Pro Mk3 Exited");
   }

...
public class DrumPadMode extends AbstractMode {
    ...
    private class ArrowPadLight {
        ...
        public ArrowPadLight(LaunchpadProMk3Surface surface, int offset, IntegerValue scrollPosition, ColorValue trackColor) {
            mOffset = offset;
    ...
    private class DrumPadLight {
        ...
        public DrumPadLight(LaunchpadProMk3Surface surface, DrumPad drumPad, AtomicBoolean playing) {
    ...
    public DrumPadMode(ControllerHost host, Session session, LaunchpadProMk3Surface surface, CursorDevice device) {
    ...
    public List<HardwareBinding> onBind(LaunchpadProMk3Surface surface) {
        ...
        for(int i = 0; i < arrows.length; i++) {
            LaunchpadProMk3Pad pad = arrows[i];

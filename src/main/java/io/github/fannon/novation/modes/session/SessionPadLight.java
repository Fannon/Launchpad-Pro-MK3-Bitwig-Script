...
public class SessionPadLight {
    ...
    public SessionPadLight(LaunchpadProMk3Surface surface, ClipLauncherSlot slot, Track track, RangedValue bpm, Consumer<LaunchpadProMk3Surface> redraw, int index) {
        mBPM = bpm;
        mArmed = track.arm();
